...
const WHATSAPP_URL = `https://wa.me/${WHATSAPP_PHONE}?text=Hi%20AutoZoneX%20team,%20I%20have%20a%20question%20about%20setting%20up%20our%20account.`;
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (err?.message?.includes('NEXT_REDIRECT') || err?.digest?.includes('NEXT_REDIRECT')) {
        return; // Redirecting successfully to dashboard
      }
  ...
  return (
    <div className="min-h-screen bg-[#07090E] text-slate-100 flex flex-col justify-between selection:bg-emerald-500 selection:text-white relative overflow-hidden font-sans">
      ...
      <div className="fixed inset-0 pointer-events-none -z-10 overflow-hidden">
        <div className="absolute -top-[15%] left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-gradient-to-b from-emerald-600/15 via-teal-600/10 to-transparent blur-[140px] rounded-full" />
        <div className="absolute bottom-[5%] -right-[10%] w-[500px] h-[500px] bg-indigo-600/10 blur-[130px] rounded-full" />
      </div>
            ...
            <div className="rounded-[15px] bg-[#0C101A]/95 border border-white/10 p-8 sm:p-10 backdrop-blur-xl">
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-xs sm:text-sm text-slate-400 mt-2">
                  Deploy your private WhatsApp CRM & AI multi-agent team
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label className="block text-xs font-semibold text-slate-300 mb-1.5" htmlFor="orgName">
                ...
                <div className="py-2 space-y-1.5 text-[11px] text-slate-400">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span>Includes 4-Agent Multi-Agent AI system</span>
                  </div>
                  <div className="flex items-center gap-1.5">
                    <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400" />
                    <span>Unlimited WhatsApp sessions & contacts</span>
                  </div>
                </div>
