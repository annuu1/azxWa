...
export default function ContactsList({ 
  ...
  // OPTIMIZATION: Memoize filtered contacts and extract toLowerCase() to prevent redundant operations on every render
  const filteredContacts = useMemo(() => {
    ...
    return contacts.filter(contact => {
      const matchesSearch =
        ...
        (contact.pushName || '').toLowerCase().includes(lowerSearchTerm) ||
        (contact.whatsappId || '').toLowerCase().includes(lowerSearchTerm);
