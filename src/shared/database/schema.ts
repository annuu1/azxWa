...
export const aiSettings = sqliteTable('ai_settings', {
  ...
  debounceSeconds: integer('debounce_seconds').default(25).notNull(),
  profilerPrompt: text('profiler_prompt'),
  strategyPrompt: text('strategy_prompt'),
  copywriterPrompt: text('copywriter_prompt'),
  stagnantPrompt: text('stagnant_prompt'),
  inboundAdPrompt: text('inbound_ad_prompt'),
